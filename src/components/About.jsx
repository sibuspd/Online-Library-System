    ...
    return (
        ...
        <div className="about-container"> 
            ...
            <div className="about-content"> 
                <h2>About Me</h2>
                <p> Hello! I'm a passionate Your Profession with a love for Web architecture and Singing. I thrive on creating impactful projects and continuously learning new skills to stay ahead in the industry. </p> 
